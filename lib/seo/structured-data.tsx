    ...
    <JsonLd
      data={{
        ...
        featureList: [
          ...
          'Multi-channel deployment: embeddable Shadow-DOM widget, Telegram (private + groups), WhatsApp Cloud API',
          'Telegram bot integration with configurable group response mode (all / mention / reply)',
          'WhatsApp Business Cloud API integration with signature-verified webhook',
          'Embeddable Shadow-DOM widget (~3.2 KB gzipped)',
          'pgvector + HNSW retrieval with cosine index',
          ...
          'Add-to-training: promote any customer Q&A into a permanent training source',
